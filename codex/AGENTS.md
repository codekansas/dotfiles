...
- Use docstrings for complex functions but avoid them for simple functions. Docstrings should include `Args` and `Returns` (unless nothing is returned). For complex mathematically-oriented functions, include detailed math notation in the docstring.
